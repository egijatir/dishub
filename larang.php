      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Data Rambu Larangan update dan dalet belum selesai
              peringatan dan seterusnya belum di perbaikin 
            </a>
          </div>
            ...
            <tr>
              <th>
                <table class="table table-striped">
                  ...
                  $query = $_POST['query'];
                  if ($query != '') {
                    $sql2   = "select * from rb_larangan WHERE id_larangan LIKE '" . $query . "'";
                    $sql2   = "select * from lampu_jalan WHERE kondisi LIKE '" . $query . "'";
                  } else {
                    $sql2   = "select * from rb_larangan order by id_larangan desc";
                  }
                  ...
                  ?>
                    ...
                    <?php } ?>
                </table><a href="#"  value="Print Table" / style="color: #000000" title="print"> <i class="large material-icons" width="90"> local_printshop </i></a>
                </tbody>
                <tr>
              <th>
                <center>
