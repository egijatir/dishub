      ...
      <nav class="navbar navbar-expand-lg navbar-transparent navbar-absolute fixed-top ">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            <a class="navbar-brand" href="javascript:;">Data Lampu Merah</a>
          </div>
            ...
            <tr>
              <th>
                <table class="table table-striped">
                  ...
                  <!-- ini but cri di dlm tble -->
                  <?php
                  $query = $_POST['query'];
                  if ($query != '') {
                    $sql2   = "select * from lampu_jalan WHERE id_lampu LIKE '" . $query . "'";
                    $sql2   = "select * from lampu_jalan WHERE kondisi LIKE '" . $query . "'";
                  } else {
                  ...
                  ?>
                    ...
                    <tbody>
                      <tr>
                        ...
                        <td>
                          <h5><a href="https://www.google.com/maps/place/<?php echo $titik_kordinat ?>" style="color: #000000" target="blank" title="KLIK UNTUK MELIHAT"><?php echo $titik_kordinat ?></a>
                        </td>
                        <td>
                          <h5><?php echo $alamat ?>
                        </td>
                        ...
                        <td>
                          <h5><a href="edit.php?id_lampu=<?php echo $r2['id_lampu']; ?>" style="color: #000000"> <i class="material-icons">edit</i></a>
                        </td>
                        <td>
                          <h5><a href="hapus.php?id_lampu=<?php echo $r2['id_lampu']; ?>" style="color: #f5330c" title="Hapus Data" onclick="return confirm('Anda yakin mau menghapus item ini ?')"><i class="material-icons">delete_forever</i></a>
                        </td>
                      </tr>
                    <?php } ?>
                </table><a href="print.php"  style="color: #000000" title="print"> <i class="large material-icons" width="90"> local_printshop </i></a>
                </tbody>
              </th>
            <tr>
              <th>
                <center>
                  <a href="#" style="color: #000000"><i class="material-icons">chevron_left</i> &nbsp;&nbsp;1&nbsp;&nbsp;&nbsp;&nbsp; 2&nbsp;&nbsp;&nbsp;&nbsp; 3 &nbsp;&nbsp;<i class="material-icons">chevron_right</i></a>
                </center>
              </th>
            </tr>
            </tr>
              ...
              <div class="modal-body">
                ...
                <form action="input.php" method="post" name="data">
                  <div class="form-group">
                    ...
                    <input type="text" name="id_lampu" class="form-control" required>
                  </div>
                  <div class="form-group">
